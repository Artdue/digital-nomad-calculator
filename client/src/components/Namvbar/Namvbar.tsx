                ...
                <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                  ...
                  {user.email ? (
                    ...
                    <button
                      type="button"
                      onClick={toLogin}
                      className="relative rounded-full bg-[#337CE5] p-1 text-white hover:text-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-[#255fd4]"
                    >
                      <span className="absolute -inset-1.5" />
